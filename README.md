...
**3,859+** picks tracked | **60.1%** NBA win rate | **17** lenders scraped daily | **20+** autonomous agents | **30** platform users | **12** analysis models | **5** live systems | **2** MCP servers on PyPI

---

## 🏈 Production Machine Learning Systems

I built a multi-sport prediction platform with 12 analysis agents that independently evaluate every game across NBA, NHL, NCAAB, and MLB — then reach consensus through weighted scoring. It serves agents with an API key and 30 users, resolves bets automatically, and feeds outcomes back into the models nightly. **Live at [sportsbettingaianalyzer.com](https://sportsbettingaianalyzer.com).**

| Project | What It Demonstrates | Links |
|---------|---------------------|-------|
| **Sports Betting MCP Server** | Published Python package to PyPI. Serves real-time sports analytics to AI agents via MCP. 12 tools, 3,859+ picks, 4 sports. | [GitHub](https://github.com/seang1121/sports-betting-mcp) / [PyPI](https://pypi.org/project/sports-betting-mcp/) |
...
| Project | What It Demonstrates | Links |
|---------|---------------------|-------|
| **Mortgage Rates MCP Server** | AI-native rate comparison across 17 major US lenders. 13 tools: rates, calculator, recommendations, rate sheets, alerts. Scrapes 2x daily. Free API. | [GitHub](https://github.com/seang1121/mortgage-rates-mcp) |
| **Multi-Lender Rate Scraper** | Stealth-browser scraper that defeats anti-bot protection on major bank websites simultaneously. Async parallel execution, day-over-day tracking. | [GitHub](https://github.com/seang1121/Multi-Lender-Mortgage-Rate-Lookup) |
...
- Mortgage Rates MCP Server — 17 lenders, 13 tools, landing page with live rates
...
- [sportsbettingaianalyzer.com](https://sportsbettingaianalyzer.com) — Live AI betting platform, 30 users, 3,859+ picks tracked
...
| Repo | Description |
|------|-------------|
| [sports-betting-mcp](https://github.com/seang1121/sports-betting-mcp) | MCP server for sports betting — 12 tools, 3,859+ picks, 4 sports |
| [mortgage-rates-mcp](https://github.com/seang1121/mortgage-rates-mcp) | MCP server for mortgage rates — 17 lenders, 13 tools, free API |
...
| [Multi-Lender-Mortgage-Rate-Lookup](https://github.com/seang1121/Multi-Lender-Mortgage-Rate-Lookup) | Stealth-browser mortgage rate scraper — 17 lenders in 90 seconds |
